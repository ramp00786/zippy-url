  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="{{url('/')}}/iitm-logo.png" class="user-image" alt="User Image">
                  <span class="hidden-xs">Admin</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="{{url('/')}}/iitm-logo.png" class="img-circle" alt="User Image">
                    <p>
                      Admin
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2013-2024 <a href="https://tropmet.res.in" target="_blank">IITM, Pune</a>.</strong> All rights reserved.
      </footer>
