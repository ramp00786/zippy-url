...
<head>
    ...
    <title>{{ config('app.name', 'ZippyURL') }}</title>
...
<body>
    ...
    <header class="header-section">
        <div class="container">
            <div class="header-wrapper">
                <div class="logo">
                    <a href="index.html">
                        <img src="{{url('/')}}/public/favicon_io/android-chrome-192x192.png" alt="logo">
                    </a>
                </div>
    ...
    <section class="banner-section">
        ...
        <div class="container">
            <div class="banner-content">
                ...
                <h1 class="title">Short Your URLs</h1>
                <p>Transforming long, ugly links into Shorten URLs (TinyURL).</p>
            </div>
                        ...
                        <div class="testimonial-area testimonial-slider owl-carousel owl-theme">
                            <div class="testimonial-item">
                                <div class="testimonial-thumb">
                                    <div class="thumb">
                                        <img src="{{url('/public')}}/theme/images/testimonials/boy.jpg" alt="client">
                                    </div>
                                </div>
                            ...
                            <div class="testimonial-item">
                                <div class="testimonial-thumb">
                                    <div class="thumb">
                                        <img src="{{url('/public')}}/theme/images/testimonials/girl.jpg" alt="client">
                                    </div>
                                </div>
                                <div class="testimonial-content">
                                    <div class="ratings">
    ...
    <footer class="footer-section padding-top">
        ...
        <div class="container">
            ...
            <div class="text-center">
                ...
                <img src="{{url('/public/theme/img/qr.jpeg')}}" alt="">
            </div>
    ...
    <script>console.log(app_url)</script>
